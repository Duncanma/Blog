...
description: I compared WebPageTest results for my old WordPress site vs. the new static Hugo build, then iterated on fonts and JavaScript to make it faster.
---
