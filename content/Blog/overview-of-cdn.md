...
description: A page that took 983ms to reach from Frankfurt dropped to 299ms once I put a CDN in front of it — here's what's actually happening behind that.
techfeatured: true
---
